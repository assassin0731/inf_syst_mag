...
<div id="banner10">
  ...
  <table id="myTable" class="table table5 display rabotniktable" style="width:100%; font-size:18px;" cellspacing='0'>
	...
	<tbody>
		<?php
		    $user=DB::select('select id,name from users order by id desc');
        $rowid=0;
          ...
          $rowid=$rowid+1;
            ...
            echo "<td style='display:none;'>$rowid</td>";
		        ...
		        echo "<td class='btnRab'><span>$users->name</span></td>";
            echo "<td style='display:none;'  data-id={$users->id}>$users->id</td>";
